...
class DLRModel {
 ...
 public:
  ...
  static DLRModel *CreateModel(std::string path, std::string device_type, int device_id);
  static DLRModel *CreateModel(std::string path, const DLContext &ctx);
  static DLRModel *CreateModel(std::string path, int device_type, int device_id);
  static DLRModel *CreateModel(std::vector<std::string> paths, int device_type, int device_id);
  static DLRModel *CreateModel(std::vector<std::string> paths, const DLContext &ctx);
