...
our %config = (
  AR => "llvm-ar",
  ARFLAGS => [ "rs" ],
  CC => "/home/dipak_kasar/Android/Sdk/ndk/20.1.5948944/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang",
  CFLAGS => [ "-Wall -O3" ],
  CPPDEFINES => [ "__ANDROID_API__=21" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "/home/dipak_kasar/Android/Sdk/ndk/20.1.5948944/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/home/dipak_kasar/Android/Sdk/ndk/20.1.5948944/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang",
  minor => "1.1",
  ...
  openssldir => "",
  options => "-D__ANDROID_API__=21 --prefix=/home/dipak_kasar/DLR_Android/neo-ai-dlr/3rdparty/openssl/build/x86_64 no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.22.1",
  perlargv => [ "android-x86_64", "no-shared", "-D__ANDROID_API__=21", "--prefix=/home/dipak_kasar/DLR_Android/neo-ai-dlr/3rdparty/openssl/build/x86_64" ],
  perlenv => {
      "AR" => "/home/dipak_kasar/Android/Sdk/ndk/20.1.5948944/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-ar",
      "BUILDFILE" => undef,
      "CC" => "/home/dipak_kasar/Android/Sdk/ndk/20.1.5948944/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang",
      "CFLAGS" => undef,
      "CPPFLAGS" => undef,
      ...
      "PERL" => undef,
      "RANLIB" => "/home/dipak_kasar/Android/Sdk/ndk/20.1.5948944/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
  ...
  prefix => "/home/dipak_kasar/DLR_Android/neo-ai-dlr/3rdparty/openssl/build/x86_64",
  processor => "",
